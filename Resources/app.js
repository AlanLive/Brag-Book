...
function buildMagazine(){
	...
	// }
	var scrollable = Ti.UI.createScrollableView({top:50, bottom:0, left:0, right:0, cacheSize:6 });
...
// 			 	
		...
		// open the client
		xhr.open('GET','http://bragbookmagazine.com/app/version.json');

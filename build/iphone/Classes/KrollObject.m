 ...
 * Copyright (c) 2009-2011 by ShopBrag, Inc. All Rights Reserved.
...
//@interface ShopBragObject : NSObject
//@end

@interface ShopBragObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ShopBragObject class]])
		{
			for (NSString *key in [[(ShopBragObject*)o modules] allKeys])
			{

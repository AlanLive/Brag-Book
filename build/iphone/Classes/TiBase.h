...
// in simulator we redefine to format for ShopBrag Developer console
...
{\
	NSString * exceptionName = [@"org.shopbrag." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.shopbrag";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIShopBragNativeItemNone = -1, 
	UIShopBragNativeItemSpinner = -2,
	UIShopBragNativeItemProgressBar = -3,
	
	UIShopBragNativeItemSlider = -4,
	UIShopBragNativeItemSwitch = -5,
	UIShopBragNativeItemMultiButton = -6,
	UIShopBragNativeItemSegmented = -7,
	
	UIShopBragNativeItemTextView = -8,
	UIShopBragNativeItemTextField = -9,
	UIShopBragNativeItemSearchBar = -10,
	
	UIShopBragNativeItemPicker = -11,
	UIShopBragNativeItemDatePicker = -12,
	
	UIShopBragNativeItemInfoLight = -13,
	UIShopBragNativeItemInfoDark = -14,
	
	UIShopBragNativeItemDisclosure = -15,
	
	UIShopBragNativeItemContactAdd = -16
};
